...
class UserProfile extends Component {
    ...
    registerUser = (e) => {
        ...
        formData.append('newUser',saveUser)
        UserService.userProfile1(formData).then((res) => {
                ...
                <div className="main " style={{ backgroundColor: 'OldLace' }} >
                    ...
                    <div className="card-body ">
                        <img style={{ width: "190px" }}
                            src="http://res.cloudinary.com/dsealyady/image/upload/v1619182063/sgb7dejtxrp4usqrwzj9.jpg"
                            alt="profile-img"
